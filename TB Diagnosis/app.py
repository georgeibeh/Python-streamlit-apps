...
st.set_page_config(page_title="TB Detection Tool", page_icon='covid19.jpeg',layout='centered',initial_sidebar_state='auto')
...
def main():
    html_templ= """
    <div style ="background-color:#2E2E41;opacity: 0.9;padding:10px; margin: 0 auto;">
    <h1 style="color:WHITE"; margin: 0 auto;>TB Detection Tool</h1>
    </div>
    """
    st.markdown(html_templ, unsafe_allow_html=True)
    st.write("A simple proposal for pulmonary tuberculosis Detection powered by Deep Learning and Streamlit")
    
    st.sidebar.image("Covid-19.jpeg", width=300)
    ...
    if image_file is not None:
        ...
        activities = ['Image Enhancement', "Diagnosis", "Disclaiimer and Info"]
    ...
    if st.sidebar.button("About the Author"):
        st.sidebar.subheader("pulmonary tuberculosis Detection Tool")
        st.sidebar.markdown("by [George Ibeh](https://www.authorswebsite.com)")
        st.sidebar.markdown("[author@gmail.com](mailto:georgeibehmails@gmail.com)")
