...
def main():
    ...
    if choice == "Text Analysis":
        ...
        if st.button('Analyze'):
            ...
            with col1:
                ...
                with st.expander("Stopwowrds"):
                    st.success("Stop Words")
    ...
    if choice == "Translation":
        ...
        st.write("")
        st.write("")
        raw_text = st.text_area("Original Text", "Write something to be translate...", height=200)
        if len(raw_text)<3:
